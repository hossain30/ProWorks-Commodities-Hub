...
const QrContainer = () => {
  return (
    <div className="qr_container">
      <div className="qr_top_section">
        <p>
          <span>1.Solutions</span> <br />
          ProWorks reduces the workload of facility purchasing by eliminating
          the time consuming task of multiple supplier sourcing through purchase
          order consolidation.
        </p>
      ...
      <div className="qr_center_section">
        <p>
          <span>2.Services</span> <br />
          Procurement of Industrial, MRO and
      ...
      <div className="qr_bottom_section">
        <p>
          <span>3.Reliability</span> <br />
          ProWorks has an excellent reputation
